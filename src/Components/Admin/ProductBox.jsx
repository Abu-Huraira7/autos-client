...
function ProductBox({fetchAllProducts,val,ind}) {
  ...
  // Exterior Images
    ...
    const [images1Opt, setImages1Opt] = useState([]);
    ...
    const handleImage1 = (e) => {
        ...
        setImages1Opt([...images1Opt, ...files]);
    ...
    const DeleteImage1 = (val,index) => {
        ...
        const updatedImagesOpt = [...images1Opt];
        updatedImagesOpt.splice(index, 1);
        setImages1Opt(updatedImagesOpt);
  ...
  const [images2Opt, setImages2Opt] = React.useState([]);
  ...
  const handleImage2 = (e) => {
      ...
      setImages2Opt([...images2Opt, ...files]);
  ...
  const DeleteImage2 = (val,index) => {
    ...
    const updatedImagesOpt = [...images2Opt];
    updatedImagesOpt.splice(index, 1);
    setImages2Opt(updatedImagesOpt);
  ...
  const [images3Opt, setImages3Opt] = React.useState([]);
  ...
  const handleImage3 = (e) => {
      ...
      setImages3Opt([...images3Opt, ...files]);
    ...
    const DeleteImage3 = (val,index) => {
        ...
        const updatedImagesOpt = [...images3Opt];
        updatedImagesOpt.splice(index, 1);
        setImages3Opt(updatedImagesOpt);
 ...
 // Documents Images
  ...
  const [images4Opt, setImages4Opt] = React.useState([]);
  ...
  const handleImage4 = (e) => {
      ...
      setImages4Opt([...images4Opt, ...files]);
  ...
  const DeleteImage4 = (val,index) => {
    ...
    const updatedImagesOpt = [...images4Opt];
    updatedImagesOpt.splice(index, 1);
    setImages4Opt(updatedImagesOpt);
  ...
  useEffect(() => {
    ...
    const image1Opt = val.exteriorImagesOptimized.map((url) => ({ url, new: false }));
    setImages1Opt(image1Opt);

    const image2 = val.interiorImages.map((url) => ({ url, new: false }));
    setImages2(image2);
    setImageURLs2(image2);
    const image2Opt = val.interiorImagesOptimized.map((url) => ({ url, new: false }));
    setImages2Opt(image2Opt);
    
    const image3 = val.mechanicalImages.map((url) => ({ url, new: false }));
    setImages3(image3);
    setImageURLs3(image3);
    const image3Opt = val.mechanicalImagesOptimized.map((url) => ({ url, new: false }));
    setImages3Opt(image3Opt);
    
    const image4 = val.documentsImages.map((url) => ({ url, new: false }));
    setImages4(image4);
    setImageURLs4(image4);
    const image4Opt = val.documentsImagesOptimized.map((url) => ({ url, new: false }));
    setImages4Opt(image4Opt);
...
//   };
  ...
  const submitform = async (event)=>{
      ...
      let Images1LinksOpt = [];
      for (let i = 0; i < images1Opt.length; i++) {  
        if(getType(images1Opt[i])==='file'){
            // formData.append('images1', images1[i]);
            // console.log(images1[i]);
        }else{
            Images1LinksOpt.push(images1Opt[i].url);
            // console.log(images1[i]);
        }
    }
      formData.append('images1Rem', JSON.stringify(Images1Links));
      formData.append('images1RemOpt', JSON.stringify(Images1LinksOpt));
      ...
      let Images2LinksOpt = [];
        for (let i = 0; i < images2Opt.length; i++) {  
            if(getType(images2Opt[i])==='file'){
                // formData.append('images2', images2[i]);
                // console.log(images1[i]);
            }else{
                Images2LinksOpt.push(images2Opt[i].url);
                // console.log(images1[i]);
            }
        }
        formData.append('images2Rem', JSON.stringify(Images2Links));
        formData.append('images2RemOpt', JSON.stringify(Images2LinksOpt));
        ...
        let Images3LinksOpt = [];
        for (let i = 0; i < images3Opt.length; i++) {  
            if(getType(images3Opt[i])==='file'){
                // formData.append('images3', images3[i]);
                // console.log(images1[i]);
            }else{
                Images3LinksOpt.push(images3Opt[i].url);
                // console.log(images1[i]);
            }
        }
        formData.append('images3Rem', JSON.stringify(Images3Links));
        formData.append('images3RemOpt', JSON.stringify(Images3LinksOpt));
        ...
        let Images4LinksOpt = [];
        for (let i = 0; i < images4Opt.length; i++) {  
            if(getType(images4Opt[i])==='file'){
                // formData.append('images4', images4[i]);
                // console.log(images1[i]);
            }else{
                Images4LinksOpt.push(images4Opt[i].url);
                // console.log(images1[i]);
            }
        }
        formData.append('images4Rem', JSON.stringify(Images4Links));
        formData.append('images4RemOpt', JSON.stringify(Images4LinksOpt));
