                                    ...
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <div className="get__wrap">
                                                ...
                                                <p>We believe our descriptions are the most detailed and engaging in the marketplace. To help us help you, please provide as much information as you can about your consignment. You are solely responsible for the factual accuracy of, and for any judgments or opinions expressed in, the description of each auction lot consigned by you, and for any error, misleading statement or omission of information in that description. As a seller, you are responsible for compliance with all relevant legislation.</p>
                                                <div className="get__list">
                                                    <ul>
                                                        ...
                                                        <li>Note any major work (full respray / engine rebuild
                                                            etc.)</li>
                                                        <li>The car must be 'as described', so be honest about faults or imperfections</li>
